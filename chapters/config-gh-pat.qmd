...
If you want to use the GitHub API directly from {{< fa brands r-project >}}, essentially with the 
...
Do not forget to restart the {{< fa brands r-project >}} session.
...
you can use `options()$"usethis.description"`.
