# Systematic reviews & meta-analyses {.unnumbered}

<br />

![](../images/collection-literaturesynthesis.png){width=50% fig-align="center"}


::: {.callout-note}
## Course information

The objective of this five-day [training course](https://literaturesynthesis.github.io/), 
co-organized by the [FRB-CESAB](https://www.fondationbiodiversite.fr/en/about-the-foundation/le-cesab/), 
the [UAR PatriNat](https://www.patrinat.fr), and the [CIRAD HortSys](https://ur-hortsys.cirad.fr/), 
is to provide an introduction to the techniques of meta-analysis and systematic 
reviews/maps applied to the field of biodiversity. It also offers an opportunity
to become familiar with various bibliographic tools (Web of Science, OpenAlex, 
Zotero, etc.) and statistical tools (R packages such as metaDigitise, metafor, etc.).
:::
