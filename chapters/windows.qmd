...
{{< fa warning >}}&nbsp; This module is required only to install [**Docker Desktop**](https://docs.docker.com/desktop/). You can ignore this step if you don't plan to install Docker.
...
| Rtools          | A toolbox to build R packages from source      | [link](https://cran.r-project.org/bin/windows/Rtools/rtools44/rtools.html) |
